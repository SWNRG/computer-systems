...
Για την αναζήτηση του περιεχομένου αρχείων μπορούμε να χρησιμοποιήσουμε τις εντολές `more` η `less`. Όταν βρισκόμαστε στο περιβάλλον των εντολών αυτών, μπορούμε να πατήσουμε `\keyword`, όπου `keyword` η λέξη που θέλουμε να αναζητήσουμε. Στη συνέχεια, θα μετακινηθεί το κείμενο στα ανάλογα σημεία και θα μαρκαριστεί η λέξη που αναζητάμε. Πατώντας το πλήκτρο `\` όσες φορές επιθυμούμε, επαναλαμβάνουμε την πιο πρόσφατη αναζήτηση μας.
...
Τη λέξη αναζήτησης μπορούμε να την περικλείουμε σε εισαγωγικά ή όχι.

Μπορούμε να πραγματοποιήσουμε και περισσότερο πολύπλοκες αναζητήσης με τη χρήση των regular expressions. Π.χ. το σύμβολο `^` οδηγεί στην αναζήτηση γραμμών που ξεκινούν από τη λέξη που ακολουθεί το σύμβολο. Για παράδειγμα:
...
Αυτή η εντολή επιστρέφει όλες τις γραμμές που περιέχουν τη λέξη "directory" και εμφανίζει τον αριθμό κάθε γραμμής μαζί με το περιεχόμενο της.
